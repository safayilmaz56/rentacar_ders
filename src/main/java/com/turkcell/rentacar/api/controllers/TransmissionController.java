...
public class TransmissionController {
    ...
    @PostMapping("/add")
    @ResponseStatus(HttpStatus.CREATED)
    public CreatedTransmissonResponse add(@RequestBody CreateTransmissonRequest createTransmissonRequest){
        return transmissionService.add(createTransmissonRequest);
    }
}